...
const RecipeForm = () => {
    ...
    return (
        <div className="w-130 min-h-screen p-6 bg-white rounded-lg shadow-lg">
            <div className="bg-gray-300 py-4 px-6 rounded-t-lg -mx-6 -mt-6 mb-6">
            ...
            <div className="space-y-6">
                    ...
                    <div className="relative" ref={dropdownRef}>
                        ...
                        >
                            {formik.values.ingredients.map((ingredient) => (
                                <div key={ingredient} className="bg-gray-300 px-2 py-1 rounded-md flex items-center gap-1 text-sm">
                                ...
                                {filteredIngredients.length > 0 ? (
                                    filteredIngredients.map((ingredient) => (
                                        <div
                                            ...
                                            className={`p-2 hover:bg-gray-100 cursor-pointer ${formik.values.ingredients.includes(ingredient) ? 'bg-gray-100' : ''}`}
                                        >
                                            <div className="flex items-center">
                                                <div className={`w-4 h-4 mr-2 border rounded ${formik.values.ingredients.includes(ingredient) ? 'bg-gray-300 border-gray-400' : 'border-gray-400'}`}>
                ...
                <button
                    ...
                    className="w-full bg-gray-400 p-3 rounded-md text-gray-800 font-bold hover:bg-gray-500 transition-colors shadow-md"
                >
                    Ajouter la recette
                </button>
            </div>
